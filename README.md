...
| [ADR-0003](docs/adr/ADR-0003-post-view-count-strategy.md) | 게시글 조회수 저장 방식과 중복 조회 처리 기준 |
| [ADR-0004](docs/adr/ADR-0004-board-name-slug-separation.md) | 게시판 표시 이름과 URL 식별자를 분리한 이유 |